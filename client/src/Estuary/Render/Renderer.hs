...
renderTextProgramChanged c z (TidalTextNotation _,x,eTime) = (parseZone miniTidal) c z x eTime
...
renderTextProgramChanged c z (TimeNot,x,eTime) = (parseZone timeNot) c z x eTime
