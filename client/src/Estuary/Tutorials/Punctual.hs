    ...
    (TutorialPage {
      ...
      tutorialPageView = GridView 1 2 [
        Views [
          ...
          Example Punctual "circle [0,0] 0.25 >> rgb",
          Example Punctual "circle [0.5,0] 0.5 >> rgb",
          Example Punctual "circle [-0.5,0.8] 0.75 >> rgb",
          Paragraph $ Map.fromList [
          ...
          Example Punctual "tri (60m) * (-20)db >> splay",
          Example Punctual "tri (48m) * (-20)db >> splay",
          Example Punctual "tri (72m) * (-20)db >> splay",
          Paragraph $ Map.fromList [
    ...
    (TutorialPage {
      ...
      tutorialPageView = GridView 1 2 [
        Views [
          ...
          Example Punctual "vline 0 0.002 >> rgb",
          Example Punctual "hline 0 0.002 >> rgb",
          Example Punctual "rect [0,0] [0.5,0.5] >> rgb",
          Example Punctual "point [0,0] >> rgb",
          Paragraph $ Map.fromList [
          ...
          Example Punctual "vline [-0.25,0,0.25] 0.002 >> rgb",
          Example Punctual "circle [-0.25,0,0.25,0,0,0] 0.25 >> rgb",
          Paragraph $ Map.fromList [
            (English,"We can also replace any number with an oscillator with a low frequency so that things move around:")
            ],
          Example Punctual "hline (tri 1) 0.002 >> rgb",
          Example Punctual "hline (tri 2) 0.002 >> rgb",
          Example Punctual "hline (tri 0.25) 0.002 >> rgb",
          Paragraph $ Map.fromList [
