...
line = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "line:"
...
rect = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "rect:"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
...
circle = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "circle:"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
...
ellipse = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "ellipse:"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
...
triangle = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "triangle:"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
...
polyline = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "polyline:"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
...
polygon = divClass "helpWrapper" $ do
   switchToReference <- divClass "code-font primary-color reference-button" $ button "polygon"
   exampleVisible <- toggle True switchToReference
   referenceVisible <- toggle False switchToReference
