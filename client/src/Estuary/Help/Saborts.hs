...
about = do
  divClass "about foreground-color small-font" $ text "Saborts"
  divClass "about foreground-color small-font" $ text "A mini live coding esolang developed in Quito, Ecuador by RGGTRN."
