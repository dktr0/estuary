...
about = do
  divClass "about foreground-color small-font" $ text "Natural"
  divClass "about foreground-color small-font" $ text "A mini live coding esolang developed in Manizales, Colombia."
