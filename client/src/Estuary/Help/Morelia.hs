...
about = do
 divClass "about foreground-color small-font" $ text "Morelia"
 divClass "about foreground-color small-font" $ text "A mini live coding esolang developed in Morelia, México."
