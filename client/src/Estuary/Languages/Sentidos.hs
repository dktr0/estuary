...
adjetivos :: GenParser Char a (Tidal.ControlPattern -> Tidal.ControlPattern)
adjetivos = choice [
...
sentimientos :: GenParser Char a (Tidal.ControlPattern -> Tidal.ControlPattern)
sentimientos = choice [
...
sentidos :: String -> Either ParseError Tidal.ControlPattern
