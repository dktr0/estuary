...
viewParser = do
  v <- choice [viewDiv,labelView,structureView,tidalTextView,evaluableTextView,cqenzeView,moreliaView, saludosView, sentidosView, siView, colombiaView, sabortsView, puntoyyaView, sucixxxView, vocesotrevezView, imaginaView, alobestiaView]
  spaces
  return v
